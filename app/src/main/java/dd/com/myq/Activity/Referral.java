...
public class Referral extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //We're not using bit.ly anymore.....we're just using user_id as the referral code.

        // You can remove bit'ly code as it's of no use
        ...
        client.get(this, getbitlyurl, new JsonHttpResponseHandler() {
            ...
            public void onSuccess(int statusCode, Header[] headers, JSONObject object) {
                try {
                    ...
                    //We are not using bit.ly anymore....we're using user_id as referral code from now.
