...
public class GroupActivity extends AppCompatActivity {
    ...
    public String REQUEST_GROUP_MEMBERS2 = "http://myish.com:10011/api/getmembers2/";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.e("iddddd: ", gp_id);
        REQUEST_GROUP_MEMBERS2 = REQUEST_GROUP_MEMBERS2 + gp_id;
        ...
        updateGroupMembers(UPDATE_MEMBERS);
        getGroupMembers(REQUEST_GROUP_MEMBERS2);
                ...
                try {
                    for(int j=0;j<responseArray.length();j++) {
                        JSONObject responseObject = responseArray.getJSONObject(j);
                            ...
                            String points = responseObject.getString("points");
